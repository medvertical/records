/**
 * New Settings Page - Rock Solid Settings Interface
 * 
 * This is the new settings page that uses the rock-solid validation settings
 * component for a modern, type-safe settings experience.
 */
