...
// Mock dependencies
vi.mock('./server/services/fhir/fhir-client', () => ({
...
describe('Server', () => {
  ...
  describe('FHIR Server Management', () => {
    ...
    it('should test FHIR server connection', async () => {
      ...
      const { FhirClient } = await import('./server/services/fhir/fhir-client')
  ...
  describe('Dashboard', () => {
    it('should get server stats', async () => {
      ...
      const { DashboardService } = await import('./server/services/dashboard/dashboard-service')
